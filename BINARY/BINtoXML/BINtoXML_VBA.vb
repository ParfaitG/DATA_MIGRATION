...
''MS ACCESS VBA
''''''''''''''''''
Private Sub BINtoXML_ACC()
On Error GoTo ErrHandle
    Dim xmlPath As String
    Dim rawDoc, xslDoc, newDoc As New MSXML2.DOMDocument   

    ' EXPORT RAW XML
    xmlPath = Application.CurrentProject.Pathh & "\CLData_ACC.xml"
...
On Error GoTo ErrHandle
    ...
    lastCol = ThisWorkbook.Worksheets(1).UsedRange.Columns.Count
    ...
    For i = 2 To lastRow
        ...
        For j = 1 to lastCol
            ...
            childNode.Text = ThisWorkbook.Worksheets(1).Cells(i, j)
    ...
    newDoc.Save Application.ActiveWorkbook.Path & "\CLData_XL.xml"  
